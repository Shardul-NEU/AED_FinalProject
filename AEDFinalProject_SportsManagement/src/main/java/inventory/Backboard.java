...
public class Backboard extends javax.swing.JFrame {
    ...
    public Backboard() {
        ...
        bkcDoc = new CRUDDatabase().getRecordByTwoKeys("game", "basketball", "item", "backboard", "inventory");
        
        orders = (ArrayList<Document>) bkcDoc.get("orders");
    ...
    private void initComponents() {
        ...
        jLabel1.setText("BackBoard Inventory");
    ...
    private void jButton1MouseClicked(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_jButton1MouseClicked
        ...
        NewOrder newOrder = new NewOrder("backboard", "basketball");
        newOrder.show();
    ...
    private void deleteOrderMouseClicked(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_deleteOrderMouseClicked
        ...
        ArrayList<Document> arr =  (ArrayList<Document>) bkcDoc.get("orders");
        int j = -1;
        ...
        ObjectId id = (ObjectId) new CRUDDatabase().getRecordByTwoKeys("game", "basketball", "item", "backboard", "inventory").get("_id");
